          ...
          <>
            <Alert show={show}>
              ...
              <div className="d-flex justify-content-end">
                <Button onClick={() => setShow(false)} style={{ backgroundColor: '#ff9500', borderColor: '#ff9500' }} block>  
                  신청하기
                </Button>
              </div>
            </Alert>
    ...
    render() {   
        return (
            <div style={{ margin: 25 }}>
                ...
                <Button type='button' style={{ padding: 10, marginTop: 25, backgroundColor: '#fff', borderColor: '#ff9500', borderRadius: 30, color: '#ff9500' }} onClick={this.handleGoBack} block>리벤지 신청</Button>
